...
describe DiscourseReachAndRights::ReachCalculator do
  ...
  describe "mailing list mode" do
    ...
    it "excludes mailing list users if they muted the category" do
      CategoryUser.create!(user: ml_user, category: category, notification_level: CategoryUser.notification_levels[:muted])
    ...
    it "counts users only once even if they are watching AND in mailing list mode" do
      CategoryUser.create!(user: ml_user, category: category, notification_level: CategoryUser.notification_levels[:watching])
  ...
  describe "watching first post" do
    ...
    before do
      ...
      CategoryUser.create!(user: first_post_user, category: category, notification_level: CategoryUser.notification_levels[:watching_first_post])
    end
